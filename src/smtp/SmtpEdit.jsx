...
/**
 * Standalone SMTP Edit page for TA users.
 * Uses TenantContext to get the current tenant ID.
 *
 * Data flow:
  ...
  if (!tenantId) {
    return (
      <Container sx={{ padding: '15px', mt: 4 }}>
        <Alert severity="info">Please select a tenant to manage SMTP settings.</Alert>
      </Container>
    );
  }
  ...
  return (
    <Container sx={{ padding: '15px', mt: 2, mb: 6 }}>
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 3 }}>
        <Typography variant="h4">SMTP Configuration</Typography>
        <Chip
