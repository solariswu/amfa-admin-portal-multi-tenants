...
const TABLE_NAME = `amfa-${process.env.ACCOUNT}-${process.env.AWS_REGION}-tenanttable`;
...
export const handler = async (event) => {
  ...
  try {
    ...
    // LIST organizations (GET with query params)
    if (method === 'GET' && event.queryStringParameters?.page) {
