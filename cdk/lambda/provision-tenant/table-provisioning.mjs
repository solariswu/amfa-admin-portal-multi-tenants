  ...
  while (Date.now() - startTime < maxWaitMs) {
    try {
      ...
      if (error instanceof ResourceNotFoundException) {
        ...
        console.log(`[Tables] ✓ ${tableName} deletion confirmed`);
        return;
      }
      throw error;
    }
